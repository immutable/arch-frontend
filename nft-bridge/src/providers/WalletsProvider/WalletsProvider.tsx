...
export const WalletsProvider = ({ children }: { children: any }) => {
  ...
  const connectL1Wallet = async (walletConfig: any) => {
  ...
  const connectL2Wallet = async (walletConfig: any) => {
  ...
  const updateL1Wallet = (payload: any) => {
    dispatch({
  ...
  const updateL2Wallet = (payload: any) => {
    dispatch({
  ...
  const setL1WalletConfig = (payload: any) => {
    dispatch({
  ...
  const setL2WalletConfig = (payload: any) => {
    dispatch({
